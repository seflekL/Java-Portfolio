...
public class C01_vucutKitleHesabi {
    public static void main(String[] args) {
   /*
Ahmet Bulutluoz
  10:02 AM
1- Kullanicinin kilo(kg) ve boyunu(cm) isteyip vucut kitle endeksini hesaplayin  (kilo*10000 / (boy *boy)) ve kisiye durumunu raporlayin
 vucut kitle endeksi :
 - 30’dan buyukse obez,
 ...
 - 20’den kucukse zayif yazdirin.
    */
// filterini olusturuken if else if ve else ona  gore yapacaksin fazlasinia gore
